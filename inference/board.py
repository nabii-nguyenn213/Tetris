...
class Board: 
    ...
    def place_spawn_piece(self, piece, piece_val, coordinate):
        block_coors = []
        first_coor = ()
        ...
        for i in range(self.row):
            for j in range(self.col):
                if (i, j) not in block_coors: 
                    ...
                    self.board[i][j] = piece_val
        return block_coors

    
    def place_piece(self, coor, piece_val):
        for i in range(self.row):
            for j in range(self.col):
                if (i, j) not in coor: 
                    self.board[i][j] = 0
    ...
    def print_board(self):
        ...
        for r in range(self.row):
            ...
            for c in range(self.col):
                ...
                elif self.board[r][c] == 1: # I shape 
                    current_row += '<ansiblue><b> []</b></ansiblue>'
                elif self.board[r][c] == 2: # J shape 
                    current_row += '<ansibrightmagenta><b> []</b></ansibrightmagenta>'
                elif self.board[r][c] == 3: # L shape 
                    current_row += '<ansibrightyellow><b> []</b></ansibrightyellow>'
                elif self.board[r][c] == 4: # O shape 
                    current_row += '<ansiyellow><b> []</b></ansiyellow>'
                elif self.board[r][c] == 5: # S shape 
                    current_row += '<ansired><b> []</b></ansired>'
                elif self.board[r][c] == 6: # T shape 
                    current_row += '<ansimagenta><b> []</b></ansimagenta>'
                elif self.board[r][c] == 7: # Z shape 
                    current_row += '<ansigreen><b> []</b></ansigreen>'

                elif self.board[r][c] == -1: # shadow 
